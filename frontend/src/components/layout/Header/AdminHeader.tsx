        ...
        <header className="bg-gradient-to-r from-blue-50/90 via-white/80 to-blue-100/80 backdrop-blur-lg px-10 py-5 flex items-center justify-between border-b border-blue-100 sticky top-0 z-50 transition-all duration-300 animate-fade-in">
            ...
            <div className="flex items-center gap-4 relative" ref={profileRef}>
                <span className="relative">
                    ...
                    />
                    {showNoti && (
                        <div className="absolute right-0 top-12 z-50 bg-white/95 backdrop-blur-lg border-2 border-blue-200 rounded-3xl shadow-xl py-3 w-72 flex flex-col gap-2 transition-all duration-300 animate-fade-in mt-2 mx-1">
                            <div className="px-5 py-2 text-base text-gray-700 font-poppins font-medium border-b border-blue-100">Notifications</div>
                            <div className="px-5 py-2 hover:bg-blue-50 rounded-xl cursor-pointer text-gray-700 font-poppins transition-all duration-200">Your appointment is confirmed!</div>
                            <div className="px-5 py-2 hover:bg-blue-50 rounded-xl cursor-pointer text-gray-700 font-poppins transition-all duration-200">New blog post: Women's Health Tips</div>
                            <div className="px-5 py-2 hover:bg-blue-50 rounded-xl cursor-pointer text-gray-700 font-poppins transition-all duration-200">Cycle tracking reminder</div>
                            <button className="mt-2 text-blue-500 hover:underline font-poppins text-sm self-end px-5" onClick={() => setShowNoti(false)}>Close</button>
                        </div>
                    )}
                </span>
                <span className="flex items-center cursor-pointer group">
                    <img src="https://i.pravatar.cc/36?img=3" alt="MyProfile" className="rounded-full w-10 h-10 border-2 border-blue-300 mx-2 hover:ring-2 hover:ring-blue-200 transition-all duration-200 shadow-md" />
