...
const PublicHeader: React.FC = () => {
    ...
    return (
        <header
            className="bg-white px-8 py-4 flex items-center justify-between border-b border-gray-200 shadow-sm sticky top-0 z-40">
            <div className="flex items-center flex-1 min-w-0 gap-8">
                <img src={logo} alt="GENHEALTH Logo" className="h-10 w-auto cursor-pointer flex-shrink-0"
                     onClick={() => navigate('/')}/>
