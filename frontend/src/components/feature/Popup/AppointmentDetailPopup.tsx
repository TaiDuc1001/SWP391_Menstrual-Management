    ...
    return (
        <Popup open={open} onClose={onClose}>
          ...
          <span className="flex items-center gap-1">
            ...
            Location: <a href="https://meet.google.com/iid-ypfx-gdt" target="_blank" rel="noopener noreferrer"
                         className="text-blue-600 underline">Google Meet</a>
          </span>
                </div>
                ...
                <div className="bg-yellow-50 rounded-lg p-4 mb-4 border border-yellow-100">
                    ...
                    <div
                        className="text-gray-600 text-sm mb-2">{appointment.ratingComment || 'The doctor gave clear and enthusiastic advice. Scheduling was very convenient.'}</div>
                    <a href="#" className="text-blue-600 text-sm underline flex items-center gap-1"><i
                        className="fa-regular fa-paper-plane"/>Send new feedback</a>
                </div>
                <div className="flex justify-end mt-6 gap-2">
                    <button className="px-4 py-2 rounded bg-blue-500 hover:bg-blue-600 text-white font-semibold">Book
                        Again
                    </button>
                </div>
            </div>
