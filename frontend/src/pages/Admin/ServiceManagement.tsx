...
import serviceIcon from '../../assets/icons/service-management.svg';
import NewServiceButton from '../../components/Button/AdminCreateButton';
const tabs = [
            ...
            <div className="bg-white rounded shadow w-full p-4">
                ...
                <div className="flex items-center justify-between mt-2 text-xs text-gray-500">
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        {[1,2,3].map((i) => (
                            <button key={i} className={`px-2 py-1 rounded ${currentPage === i ? 'bg-blue-600 text-white' : 'bg-white border'}`}>{i}</button>
                        ))}
