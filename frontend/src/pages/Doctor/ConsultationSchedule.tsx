                ...
                <div className="bg-white rounded-lg max-w-2xl w-full p-6">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6">
                        ...
                        <div>
                            ...
                            <span
                                className={`inline-block px-3 py-1 rounded-full text-sm ${getStatusColor(appointment.status)}`}>
                {appointment.status}
              </span>
                        </div>
                    </div>
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <div className="mt-4">
                                    ...
                                    <span
                                        className={`inline-block px-3 py-1 rounded-full text-sm ${getStatusColor(selectedAppointment.status)}`}>
