                    ...
                    <div className="lg:col-span-2">
                        {selectedQuestion ? (
                                    ...
                                    <div className="mb-6">
                                        ...
                                        <div className="bg-blue-50 p-4 rounded-lg">
                                            ...
                                            <p className="text-sm text-gray-500 mt-2">
                                                Trả lời
                                                lúc: {format(new Date(selectedQuestion.response.answeredAt), 'HH:mm dd/MM/yyyy')}
                                            </p>
                                        </div>
                                    </div>
                                )}
                            ...
                            <div className="bg-white rounded-xl shadow-md p-6 text-center">
                                ...
                                <p className="text-gray-600">Chọn một câu hỏi từ danh sách bên trái để xem chi tiết và
                                    trả lời</p>
                            </div>
                        )}
                    </div>
