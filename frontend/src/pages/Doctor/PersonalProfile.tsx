            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              <div className="space-y-4">
                {(isEditing ? editedProfile.education : profile.education)?.map((edu, index) => (
                  <div key={edu.id} className="flex justify-between items-start border-b pb-4 last:border-0">
                    <div>
                      {isEditing ? (
                    ...
                    <div className="text-gray-500">
                      {isEditing ? (
                        <input
                          ...
                          onChange={(e) => {
                            const updatedEducation = [...(editedProfile.education || [])];
                            updatedEducation[index] = { ...edu, year: parseInt(e.target.value) };
                            handleInputChange('education', updatedEducation);
                          }}
                        />
                      ) : (
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              <div className="space-y-4">
                {(isEditing ? editedProfile.certifications : profile.certifications)?.map((cert, index) => (
                  <div key={cert.id} className="flex justify-between items-start border-b pb-4 last:border-0">
                    <div>
                      {isEditing ? (
                        <div className="space-y-2">
                          <input
