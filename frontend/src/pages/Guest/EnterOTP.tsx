            ...
            <div className="w-full max-w-xl bg-white rounded-2xl shadow-2xl p-12 flex flex-col items-center">
                <div className="bg-pink-100 rounded-full p-3 mb-2 mt-2 flex items-center justify-center">
                    <svg width="48" height="48" fill="none" viewBox="0 0 24 24">
                        ...
                        <path d="M18 6l-3 3-1-1" stroke="#fff" strokeWidth="1.5" strokeLinecap="round"
              ...
              <span className="absolute left-3 top-1/2 -translate-y-1/2 flex items-center h-10">
                <img src={avatarIcon} alt="otp" className="w-5 h-5 opacity-80"/>
                    ...
                    <button type="submit"
                            className="bg-pink-400 text-white px-6 py-3 rounded font-semibold text-lg w-full max-w-md hover:bg-pink-500 transition mb-8 shadow">Reset
                        Password
                    </button>
                    ...
                    <div className="flex gap-3 mt-2 w-full max-w-md">
                        ...
                        <button type="button"
                                className="flex-1 flex items-center justify-center border border-gray-300 rounded px-2 py-2 bg-white hover:bg-gray-50 transition">
                            <img src={facebookIcon} alt="Facebook" className="w-5 h-5 mr-2"/>Facebook
                        </button>
                    </div>
                </form>
            </div>
