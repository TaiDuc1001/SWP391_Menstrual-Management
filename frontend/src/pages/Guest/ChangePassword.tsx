            ...
            <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl p-8 flex flex-col items-center">
                <div className="bg-pink-400 rounded-full p-3 mb-2 flex items-center justify-center">
                    <svg width="48" height="48" fill="none" viewBox="0 0 24 24">
                        ...
                        <path d="M12 8v6" stroke="#ec4899" strokeWidth="2" strokeLinecap="round"/>
              ...
              <span className="absolute left-3 top-1/2 -translate-y-1/2 flex items-center h-10">
                <img src={keyIcon} alt="key" className="w-5 h-5 opacity-80"/>
                            ...
                            <button type="button" onClick={() => setShowPassword(v => !v)}
                                    className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center h-10 focus:outline-none">
              ...
              <span className="absolute left-3 top-1/2 -translate-y-1/2 flex items-center h-10">
                <img src={keyIcon} alt="key" className="w-5 h-5 opacity-80"/>
                    ...
                    <button type="submit" disabled={!agree || password !== rePassword}
                            className="bg-pink-400 text-white px-6 py-3 rounded font-semibold text-lg w-full hover:bg-pink-500 transition disabled:opacity-50 mb-2 shadow">Change
                        Password
                    </button>
                </form>
            </div>
