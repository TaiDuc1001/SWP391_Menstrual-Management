    ...
    <div className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-r from-blue-50 to-pink-50">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl p-8 flex flex-col items-center">
        ...
        <form onSubmit={handleSubmit} className="w-full">
          ...
          <button type="submit" disabled={!agree} className="bg-pink-400 text-white px-6 py-3 rounded font-semibold text-lg w-full hover:bg-pink-500 transition disabled:opacity-50 mb-6 shadow">Register</button>
          ...
          <div className="flex gap-3 mt-2">
            <button type="button" className="flex-1 flex items-center justify-center border border-gray-300 rounded px-2 py-2 bg-white hover:bg-gray-50 transition"><img src={google} alt="Google" className="w-5 h-5 mr-2" />Google</button>
            <button type="button" className="flex-1 flex items-center justify-center border border-gray-300 rounded px-2 py-2 bg-white hover:bg-gray-50 transition"><img src={facebook} alt="Facebook" className="w-5 h-5 mr-2" />Facebook</button>
          </div>
        </form>
      </div>
    </div>
