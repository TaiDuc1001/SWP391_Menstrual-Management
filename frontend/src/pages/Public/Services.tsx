    ...
    <div className="bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 min-h-screen pb-16">
      ...
      <div className="max-w-5xl mx-auto rounded-3xl overflow-hidden mb-10 shadow-2xl mt-8 relative z-10 border-8 border-white bg-gradient-to-br from-blue-200 via-purple-100 to-pink-100 animate-fadeIn">
        <div className="aspect-[21/9] relative">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-2 text-center drop-shadow-lg" style={{
      ...
      <div className="max-w-3xl mx-auto bg-white/90 rounded-2xl flex flex-col md:flex-row items-center gap-8 p-8 mt-4 mb-12 shadow-xl border-2 border-pink-100 animate-fadeIn">
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-700 text-lg mb-3 leading-relaxed">
            We provide a range of services from professional consultation, laboratory testing, to menstrual cycle calculation tools. Our dedicated medical staff and customers will always accompany your health journey.
          </p>
      ...
      <div className="max-w-6xl mx-auto flex flex-col items-center mb-16 animate-fadeIn">
        ...
        <div className="flex w-full justify-center gap-8 mb-4 flex-wrap">
          {serviceCards.map((item, idx) => (
            <div key={idx} className="bg-white rounded-3xl border-2 border-pink-100 shadow-xl flex flex-col items-center p-10 w-80 min-h-[260px] hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group relative overflow-hidden">
              <div className="absolute -top-8 right-8 w-24 h-24 bg-pink-100 rounded-full blur-2xl opacity-40 group-hover:opacity-60 transition-all duration-300"></div>
              <img src={item.icon} alt={item.title} className="w-16 h-16 mb-6 drop-shadow-md group-hover:scale-110 transition-transform duration-300" />
              <div className="font-extrabold text-xl text-purple-700 mb-3 text-center group-hover:text-pink-500 transition-colors duration-300">{item.title === 'Tư vấn' ? 'Consultation' : item.title === 'Gói xét nghiệm' ? 'Test Packages' : 'Menstrual Cycle Calculator'}</div>
              <button
      ...
      <div className="max-w-3xl mx-auto bg-gradient-to-r from-purple-100 via-pink-50 to-blue-100 rounded-2xl flex items-center gap-8 p-10 mt-8 shadow-xl border-2 border-purple-100 animate-fadeIn">
        ...
        <div>
          ...
          <p className="text-gray-700 mb-3 text-lg leading-relaxed">Our health consultation service is provided by a team of professional doctors, ready to answer your health-related questions.</p>
          <button
