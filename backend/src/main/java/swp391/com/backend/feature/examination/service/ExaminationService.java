...
public class ExaminationService {
    ...
    public EntityModel<ExaminationDTO> getExaminationById(Long id) {
        return toModel(examinationRepository.findExaminationById(id));
    }

    public CollectionModel<EntityModel<ExaminationDTO>> getAllExaminations() {
        return toCollectionModel(examinationRepository.findAll());
    }
    ...
    @Transactional
    public EntityModel<ExaminationDTO> updateExamination(Examination examination) {
        return toModel(examinationRepository.save(examination));
    }
    ...
    public EntityModel<ExaminationDTO> updateExaminationStatus(Long id, ExaminationDTO dto) {
        ...
        if(dto.getExaminationStatus() == null){
            throw new IllegalArgumentException("Examination status cannot be null");
        }
        ...
        return toModel(examinationRepository.save(existingExamination));
    }

    public EntityModel<ExaminationDTO> updateExaminationStatusWithStaff(Long id, ExaminationDTO dto) {
        updateExaminationStatus(id, dto);
        Examination existingExamination = findExaminationById(id);
        ExaminationStatus status = existingExamination.getExaminationStatus();
    ...
    public EntityModel<ExaminationDTO> updateExamination(Long id, ExaminationDTO dto){
        Examination existingExamination = findExaminationById(id);
    ...
    public EntityModel<ExaminationDTO> cancelExamination(Long id) {
        Examination existingExamination = findExaminationById(id);
    ...
    public CollectionModel<EntityModel<ExaminationDTO>> getExaminationsByStaffId(Long id) {
        return toCollectionModel(examinationRepository.findExaminationsByStaffId(id));
    }

    public CollectionModel<EntityModel<ExaminationDTO>> getExaminationsByCustomerId(Long customerId) {
        return toCollectionModel(examinationRepository.findExaminationsByCustomerId(customerId));
    }

    public ExaminationPaymentInfo getExaminationPaymentInfo(Long id) {
    ...
    public ResponseEntity<EntityModel<ExaminationDTO>> handleExaminationPaymentCallback(Long id, Map<String, String> queryParams) {
        Examination examination = findExaminationById(id);
        if (examination.getExaminationStatus() != ExaminationStatus.PENDING) {
            throw new IllegalStateException("Examination status is not PENDING");
        }
